...
window.HearI18n = (function () {
  ...
  const dict = {
    ...
    ko: {
      ...
      'collect.sharedPanel.p': '"HEAR의 공유 모델에 기여"를 체크하고 저장한 시퀀스는 저장하는 순간 이미 실시간으로 게시됩니다 — Save 버튼 위의 안내를 참고하세요. 이 섹션은 별도의 수동 백업 경로입니다: 공유로 표시된 항목을 파일로 내보내, 위의 실시간 경로 대신(또는 그에 더해) 검토된 스냅샷을 관리자에게 전달하고 싶을 때 사용하세요.',
