...
window.HearI18n = (function () {
  ...
  const dict = {
    ...
    ko: {
      ...
      'index.how.c1.p': '짧은 인터랙티브 스크리닝으로 다양한 소리와 청취 환경에 대한 반응을 살펴봅니다.',
      'index.how.c2.h3': '2. 프로필 확인하기',
      'index.how.c2.p': '나에게 더 어려울 수 있는 상황을 담은 맞춤형 청취 프로필을 받아보세요.',
      ...
      'about.p5': '[제작] — 그 결과물이 HEAR입니다: 청력 손실을 설명하는 데 그치지 않고, 소통 그 자체를 다루도록 돕는 플랫폼 — 자신의 청취 경험을 이해하고, 나에게 맞는 전략을 찾고, Live Hear 같은 도구를 실제 순간에 사용할 수 있도록.',
      'about.statement': '"얼마나 잘 들리나요?"라고만 묻지 마세요. "세상이 당신과 얼마나 잘 소통하고 있나요?"라고 물어보세요.',
      'about.what.kicker': 'HEAR란',
      'about.what.h2': '진단이 아닌 플랫폼',
      'about.what.p': 'HEAR는 실제 청력 손실 경험에서 영감을 받은 웹 기반 접근성 플랫폼입니다. 청력 손실을 하나의 의학적 상태로만 다루기보다, 사람들이 소통의 장벽을 실제로 경험하는 일상 환경 — 교실, 식당, 회의, 가장 가까운 사람들과의 대화 — 을 중심으로 설계되었습니다. 이 플랫폼은 인터랙티브 청취 평가, 맞춤형 접근성 추천, 실시간 자막, 익명 사용자 인사이트를 결합합니다.',
      'about.notice': 'HEAR는 의료기기가 아니며 청력 손실을 진단하지 않습니다. 청력에 대한 우려가 있다면 자격을 갖춘 청각 전문가와 상담하는 것을 권장합니다.',
      ...
      'exp.notice': '이것은 교육용 시뮬레이션입니다. 모든 사람의 청력 손실 경험을 그대로 재현하지는 않으며, 사람마다 청력 손실을 경험하는 방식은 다릅니다.',
      'exp.classroom.h3': '교실',
      'exp.classroom.p': '명료도가 낮아지고 교실 소음이 섞인 수업을 들어보세요.',
      ...
      'profile.empty.h2': '아직 청취 프로필이 없습니다',
      'profile.empty.p': '맞춤 결과를 보려면 먼저 스크리닝을 진행해주세요.',
      'profile.empty.cta': '내 청취 경험 확인하기 →',
      'profile.results.kicker': '결과',
      'profile.results.h2': '나의 청취 프로필',
