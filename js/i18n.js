...
window.HearI18n = (function () {
  ...
  const dict = {
    en: {
      ...
      'collect.consent.shared.sub': 'Included when you export a shared-contribution file for someone to merge into the community dataset.',
      'collect.sharedPanel.h3': 'Shared model contribution',
      'collect.sharedPanel.p': "HEAR doesn't have a live server yet, so \u201cshared model\u201d today means: sequences marked as shared can be exported as a separate file, handed to a maintainer, checked over, and merged into a community dataset that gets redistributed for everyone to import. Nothing is uploaded automatically.",
    ...
    ko: {
      ...
      'nav.insights': '인사이트',
      'nav.about': '소개',
      'footer.tagline': 'HEAR — 일상적인 의사소통을 위한 웹 기반 접근성 플랫폼입니다.',
      'footer.notice': '의료기기가 아니며, 청력의 손실을 진단하지 않습니다.',

      'index.title': 'HEAR — 일상적인 의사소통을 더 쉽게 만듭니다.',
      'index.eyebrow': '접근성 플랫폼',
      'index.h1': 'HEAR',
      'index.lede': '듣는 방식은 사람마다 다릅니다.',
      'index.sub': 'HEAR는 당신의 청취 경험을 이해하고, 나와 주변 사람 모두를 위해 일상적인 소통을 더 쉽게 만들어 줄 도구를 찾도록 돕습니다.',
      'index.cta1': '내 청력 확인하기 →',
      ...
      'index.how.h2': '청력 검사 부터 오늘 바로 쓸 수 있는 도구까지.',
      'index.how.c1.h3': '1. 경험 확인하기',
      'index.how.c1.p': '짧은 대화형 검사를 통해 다양한 소리와 청취 환경에 대한 반응을 살펴봅니다.',
      'index.how.c2.h3': '2. 프로필 확인하기',
      'index.how.c2.p': '나에게 더 어려울 수 있는 상황을 담은 맞춤형 청력 진단을 받아보세요.',
      ...
      'about.p1': '[경험] — 자신의 청취 경험 속 구체적인 순간에서 시작하세요: 장소, 대화, 소통이 어긋났던 순간 중 오래 남은 것.',
      'about.p2': '[발견] — 관심을 기울이기 시작하면서 보이기 시작한 패턴을 설명하세요: 일상 소통이 얼마나 "사람들이 듣는 방식"에 대한 가정에 의존하는지, 그리고 그것이 다른 사람들에게는 얼마나 보이지 않는지.',
      'about.p3': '[질문] — 그 패턴이 남긴 질문은 무엇이었나요? 접근성 도구가 왜 지금과 같은 방식으로만 존재하는지, 아니면 왜 적응의 부담이 청력 손실 당사자에게만 지워지는지에 대한 질문이었나요?',
      'about.p4': '[조사] — 문제를 더 잘 이해하기 위해 무엇을 찾아보았나요 — 다른 난청 당사자들과의 대화, 의사소통 접근성에 대한 연구, 시도해봤지만 부족했던 기존 도구들.',
      'about.p5': '[제작] — 그 결과물이 HEAR입니다: 난청을 설명하는 데 그치지 않고, 소통 그 자체를 다루도록 돕는 플랫폼 — 자신의 청취 경험을 이해하고, 나에게 맞는 전략을 찾고, Live Hear 같은 도구를 실제 순간에 사용할 수 있도록.',
      'about.statement': '"얼마나 잘 들리나요?"라고만 묻지 마세요. "세상이 당신과 얼마나 잘 소통하고 있나요?"라고 물어보세요.',
      'about.what.kicker': 'HEAR란',
      'about.what.h2': '진단이 아닌 플랫폼',
      'about.what.p': 'HEAR는 실제 난청 경험에서 영감을 받은 웹 기반 접근성 플랫폼입니다. 난청을 하나의 의학적 상태로만 다루기보다, 사람들이 소통의 장벽을 실제로 경험하는 일상 환경 — 교실, 식당, 회의, 가장 가까운 사람들과의 대화 — 을 중심으로 설계되었습니다. 이 플랫폼은 인터랙티브 청취 평가, 맞춤형 접근성 추천, 실시간 자막, 익명 사용자 인사이트를 결합합니다.',
      'about.notice': 'HEAR는 의료기기가 아니며 청력의 손실을 진단하지 않습니다. 청력에 대한 우려가 있다면 전문의와 상담하는 것을 권장합니다.',

      'access.title': '접근성 높이기 — HEAR',
      'access.kicker': '주변 사람들을 위해',
      'access.h1': '의사소통을 더 접근하기 쉽게 만드세요.',
      'access.sub': '작은 변화가 모두의 대화를 더 편하게 만들 수 있습니다.',
      'access.tab.teachers': '👩\u200d🏫 교사·선생님을 위해',
      'access.tab.families': '👨\u200d👩\u200d👧 가족을 위해',
      'access.tab.friends': '🧑 친구·급우를 위해',
      'access.teachers.before.h3': '말하기 전에',
      'access.teachers.before.li1': '먼저 학생의 주의를 끌기',
      'access.teachers.before.li2': '학생을 정면으로 마주보기',
      'access.teachers.before.li3': '중요한 정보는 시각적으로도 제공하기',
      'access.teachers.during.h3': '수업 중',
      'access.teachers.during.li1': '학급을 등지고 말하지 않기',
      'access.teachers.during.li2': '불필요한 배경 소음 줄이기',
      'access.teachers.during.li3': '필요하면 중요한 내용을 반복하거나 다르게 표현하기',
      'access.teachers.group.h3': '그룹 토론',
      'access.teachers.group.li1': '한 번에 한 사람씩 말하도록 유도하기',
      'access.teachers.group.li2': '말하기 전에 발언자를 알려주기',
      'access.teachers.group.li3': '구두 지시와 함께 서면 지시도 제공하기',
      'access.families.home.h3': '집에서',
      'access.families.home.li1': '대화를 시작하기 전에 주의를 끌기',
      'access.families.home.li2': '대화 중에는 TV나 음악 소리 줄이기',
      'access.families.home.li3': '특히 방 건너편에서 말할 땐 마주보고 말하기',
      'access.families.gath.h3': '가족 모임',
      'access.families.gath.li1': '주방이나 스피커에서 떨어진 조용한 자리 선택하기',
      'access.families.gath.li2': '가능하면 한 번에 한 사람씩 말하기',
      'access.families.gath.li3': '놓친 부분이 있으면 지목하지 않고 조용히 따로 확인하기',
      'access.friends.conv.h3': '대화 중에',
      'access.friends.conv.li1': '스쳐 지나가듯 말할 때도 마주보고 말하기',
      'access.friends.conv.li2': '그냥 더 크게 반복하기보다 다르게 표현하기',
      'access.friends.conv.li3': '중요한 대화는 더 조용한 곳을 제안하기',
      'access.friends.groups.h3': '그룹에서',
      'access.friends.groups.li1': '서로 말이 겹치지 않게 하기',
      'access.friends.groups.li2': '주제가 빠르게 바뀌면 핵심을 다시 정리해주기',
      'access.friends.groups.li3': '짐작하지 말고 무엇이 도움이 되는지 물어보기',
      'access.statement': '"얼마나 잘 들리나요?"라고만 묻지 마세요. "세상이 당신과 얼마나 잘 소통하고 있나요?"라고 물어보세요.',

      'exp.title': '체험하기 — HEAR',
      'exp.kicker': '직접 체험해보기',
      'exp.h1': '어려운 청취 환경을 체험해보세요.',
      'exp.notice': '이것은 교육용 시뮬레이션입니다. 모든 사람의 난청 경험을 그대로 재현하지는 않으며, 사람마다 난청을 경험하는 방식은 다릅니다.',
      'exp.classroom.h3': '교실',
      'exp.classroom.p': '소리의 명료도가 낮아지고 교실 소음이 섞인 수업을 들어보세요.',
      'exp.restaurant.h3': '식당',
      'exp.restaurant.p': '그릇 부딪히는 소리와 옆 테이블 소음 속에서 대화를 따라가 보세요.',
      'exp.group.h3': '그룹 대화',
      'exp.group.p': '빠르게 진행되는 그룹 대화 속에서 여러 목소리가 겹칩니다.',
      'exp.sim.label': '시뮬레이션',
      ...
      'insights.h1': 'HEAR 사용자들이 말하는 것들.',
      'insights.sub': 'HEAR 사용자들의 익명 응답을 기반으로 합니다. 이름, 이메일, 의료 정보는 수집하지 않습니다.',
      'insights.envs.h3': '가장 어려운 환경',
      'insights.strats.h3': '가장 도움이 되는 전략',
      ...
      'insights.strat.written': '서면 지시',
      'insights.strat.seating': '좌석 위치',
      'insights.notice': '이 수치는 현재 버전 HEAR의 예시 데이터입니다. 더 많은 사용자가 스크리닝과 접근성 프로필을 완료할수록, 이 페이지는 실제 익명 집계 결과를 반영하게 됩니다 — 개별 응답은 절대 공개되지 않습니다.',

      'hear.title': '실시간 자막 — HEAR',
      'hear.kicker': '실시간 자막',
      'hear.h1': 'Live Hear',
      'hear.sub': '말을 실시간으로 접근 가능한 텍스트로 바꿔줍니다 — 브라우저에서 바로.',
      ...
      'profile.title': '나의 청취 프로필 — HEAR',
      'profile.empty.h2': '아직 청력 프로필이 없습니다',
      'profile.empty.p': '맞춤 결과를 보려면 먼저 스크리닝을 진행해주세요.',
      'profile.empty.cta': '내 청력 진단하기 →',
      'profile.results.kicker': '결과',
      'profile.results.h2': '나의 청력 프로필',
      'profile.results.p': '이 결과는 이번 스크리닝 동안의 반응을 설명하는 것으로, 청력도(audiogram)나 의학적 진단으로 해석되어서는 안 됩니다.',
      'profile.strongest.kicker': '가장 강한 영역',
      'profile.challenge.kicker': '더 어려울 수 있는 영역',
      ...
      'metric.detectionLeft': '소리 감지 — 좌측',
      'metric.detectionRight': '소리 감지 — 우측',
      'metric.localization': '소리 위치 파악',
      'metric.speechQuiet': '음성 — 조용한 환경',
      'metric.speechNoise': '음성 — 배경 소음',
      'metric.tonesSub': '5개 중 {n}개 음 감지',
      'metric.localizationSub': '방향 판별 정확도',
      'metric.speechSub': '단어 단위 인식 정확도',
      'score.detectionLeft': '왼쪽 채널에 제시된 소리',
      'score.detectionRight': '오른쪽 채널에 제시된 소리',
      'score.localization': '소리가 어디서 왔는지 파악하기',
      'score.speechQuiet': '조용한 환경에서 제시된 음성',
      'score.speechNoise': '배경 소음과 함께 제시된 음성',
      'profile.strongestText': '{list} 항목에서 꾸준히 좋은 결과를 보였습니다.',
      'profile.challengeText': '{list} 항목에서는 반응이 상대적으로 일관되지 않았습니다.',
      'rec.speechNoise.title': '배경 소음 줄이기',
      'rec.speechNoise.body': '가능하다면 더 조용한 공간으로 옮기거나 주변 소음원을 줄여보세요.',
      ...
      'rec.speechQuiet.body': '중요한 대화나 지시사항에는, 편안한 청취 환경에서도 실시간 자막이 명료함을 더해줄 수 있습니다.',
      'rec.default.title': '자막 사용하기',
      'rec.default.body': '중요한 대화나 지시사항에는 HEAR의 Live Hear 자막 도구를 사용해보세요.',
      ...
      'profile.accessSummary.empty': '위에서 상황을 선택하면 맞춤 요약을 볼 수 있습니다.',
      ...
      'screen.intro.h2': '소리를 어떻게 경험하시나요?',
      'screen.intro.p': '다양한 소리에 대한 반응을 살펴보는 짧은 인터랙티브 스크리닝입니다. 약 4~5분 정도 소요됩니다.',
      'screen.intro.notice': '이 스크리닝은 의학적 청력 검사나 진단이 아닙니다. 결과는 기기와 청취 환경에 따라 달라질 수 있습니다. 청력에 대한 우려가 있다면 자격을 갖춘 청각 전문가와 상담하세요.',
      ...
      'screen.done.h2': '스크리닝을 완료해주셔서 감사합니다.',
      'screen.done.p': '지금 청취 프로필을 준비하고 있습니다.',
      'screen.done.cta': '내 청취 프로필 보기 →',

      'sign.title': '수어 → 텍스트 — HEAR',
      'sign.kicker': '실험적 기능 · V2',
      'sign.h1': '수어 → 텍스트',
      'sign.sub': '수어, 말, 또는 둘 다로 소통해보세요. 이 실험적 도구는 카메라로 양손을 추적하고, 정지된 손 모양이 아니라 움직임까지 포함해 계속 확장되는 커뮤니티 기반 수어 어휘를 인식합니다.',
      'sign.notice': '프로토타입 안내: 이 도구는 아래에 표시된 어휘를 인식하며, 여러분과 같은 브라우저에서 녹화된 영상 시퀀스로 학습되었습니다. 전문 통역을 대체하는 용도로 사용해서는 안 되며, 정확도는 각 수어 뒤에 있는 학습 데이터에 전적으로 달려 있습니다.',
      ...
      'sign.perm.p': 'HEAR는 브라우저에서 로컬로 손 움직임을 분석하기 위해 카메라를 사용합니다. 카메라 영상은 업로드되지 않습니다.',
      ...
      'sign.footerNote': '정확도를 높이거나 직접 수어를 추가하고 싶으신가요? {collectLink}로 학습 시퀀스를 녹화하거나, {accuracyLink}를 확인해보세요.',
      'sign.collectLinkText': '데이터 수집 도구',
      'sign.accuracyLinkText': '현재 모델 정확도',
      ...
      'sign.datasetNotice': '학습 데이터가 아직 부족해요. Sign to Text는 직접 녹화한 영상 시퀀스로 학습됩니다. 실시간 인식을 시도하기 전에 {link}에서 몇 가지 수어를 가르쳐주세요.',

      'collect.title': '수어 데이터 수집 — HEAR',
      'collect.back': '← 수어 → 텍스트로 돌아가기',
      'collect.kicker': '개발자 도구 · V2',
      'collect.h1': '수어 데이터 수집',
      'collect.p': 'HEAR의 온디바이스 수어 분류기를 학습시키기 위해 각 수어의 짧은 영상 시퀀스를 녹화하세요. 각 녹화는 양손을 프레임 단위로 캡처하여, 모델이 정지된 손 모양이 아니라 수어의 움직임을 학습할 수 있게 합니다. 아무것도 업로드되지 않습니다 — 시퀀스는 이 브라우저의 로컬 저장소에 저장됩니다.',
      'collect.langSection.h2': '언어 / 데이터셋',
      'collect.langSection.p': 'ASL과 KSL은 서로 별개의 어휘, 별개의 데이터셋, 별개의 모델을 가집니다 — 여기서 녹화한 시퀀스는 아래에서 선택한 언어만 학습시킵니다.',
      'collect.addSign.h3': '새 수어 추가',
      'collect.addSign.p': '이는 라벨만 생성합니다 — 실제로 쓸모 있으려면 당신(또는 다른 수집자)이 그 수어의 실제 시퀀스를 녹화해야 합니다. 단어를 추가한다고 해서 그 수어가 자동으로 만들어지지는 않습니다.',
      ...
      'collect.perm.p': '카메라 영상은 로컬에서 처리되며 HEAR로 업로드되지 않습니다.',
      ...
      'collect.perSign.hint': '수어를 눌러 개별 녹화 목록을 보고, 필요하면 하나만 삭제할 수 있습니다.',
      'collect.manage.h3': '데이터셋 관리',
      'collect.manage.p': '녹화 데이터를 백업하거나 협업자와 공유하려면 내보내고, 다른 사람이 녹화한 데이터셋을 가져올 수도 있습니다.',
      ...
      'collect.consent.shared.sub': '공유 기여 파일을 내보낼 때 포함되어, 커뮤니티 데이터셋에 병합될 수 있습니다.',
      'collect.sharedPanel.h3': '공유 모델 기여',
      'collect.sharedPanel.p': 'HEAR에는 아직 실시간 서버가 없어서, 지금의 "공유 모델"은 다음을 의미합니다: 공유로 표시된 시퀀스를 별도 파일로 내보내 관리자에게 전달하면, 검토 후 커뮤니티 데이터셋에 병합되어 모두가 가져올 수 있게 재배포됩니다. 자동으로 업로드되는 것은 없습니다.',
      'collect.sharedPanel.gate': '하나의 수어는 서로 다른 수집자 최소 {people}명으로부터 공유 시퀀스가 최소 {min}개 모이면 기여 가능 상태가 됩니다.',
      'collect.exportShared': '공유 기여 내보내기(.json)',
      'collect.exportShared.none': '아직 기여 기준을 충족한 수어가 없습니다 — "HEAR의 공유 모델에 기여"를 선택한 채로 계속 녹화해 주세요.',
      'collect.sharedReady.h3': '기여 가능',
      'collect.sharedReady.none': '아직 없음',
      'collect.importMerge.notice': '가져오기는 기존 데이터셋에 시퀀스를 병합합니다 — 이미 녹화한 내용을 대체하거나 삭제하지 않습니다.',
      'collect.status.core': '기본',
      'collect.status.pending': '검증 대기',
      'collect.status.validated': '검증됨',
      'collect.perCollector.h3': '수집자별 시퀀스 수',
      'collect.perCollector.p': '실제로 시퀀스를 녹화한 수집자만 표시됩니다.',
      'collect.accuracy.h2': '모델 정확도',
      'collect.accuracy.p': '녹화된 시퀀스에 대해 leave-one-out 교차검증으로 추정합니다: 각 시퀀스를 다른 모든 시퀀스와 프레임 단위로 비교하므로, 이는 실제 데이터에 대한 성능을 반영합니다 — 임의의 수치가 아닙니다.',
      'collect.evalBtn': '정확도 평가',
      'collect.generalization.h2': '미확인 사용자 정확도',
      'collect.generalization.p': '한 번에 한 수집자의 시퀀스를 제외한 뒤, 나머지 데이터로만 학습시켜 제외된 사람에 대해 테스트합니다. 이는 위의 수치와는 다른 질문에 답합니다: "모델이 이 데이터를 기억하는가"가 아니라 "한 번도 본 적 없는 사람의 수어에도 일반화되는가"입니다. 최소 두 명 이상의 수집자 데이터가 필요합니다.',
      ...
      'collect.unseenAccuracy': '미확인 사용자 정확도 (수집자 {people}명, 제외된 시퀀스 {n}개)',
